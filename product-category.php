 ...
 * Copyright C2009G
 *
 * Trang hiển thị danh sách các sản phẩm cùng loại.
 * @todo Bổ sung tính năng lọc theo khoảng giá. Xem cách làm ở file manufacturer-info.php
 */
// Cấu hình hệ thống
...
foreach ($results as $result) 
{
	$sub_categories[] = array(
	    ...
	    'url_image' => URL_IMAGE.$result['image']
	);
}
...
$_limits = array_unique(array(5, 10, 15, 20, 25));
