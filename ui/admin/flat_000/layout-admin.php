		...
		<div id="header" class="header navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="/admin.php" class="navbar-brand" title="Trang Quản Trị Của Nội Bộ Nhân Viên">
						<!-- Admin Panel -->
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
					 ...
					 -->
					<li>
						<a href="/index.php" title="Trang Chủ Dành Cho Khách" target="_blank"><i class="fa fa-home"></i>&nbsp;Home Frontend</a>
					</li>
					<!-- 
					<li class="dropdown">
					...
					<li><a href="/admin-logout.php" title="Đăng Thoát Khỏi Trang Quản Trị"><i class="fa fa-sign-out fa-lg"></i>&nbsp;Log Out</a></li>
					<!--
			...
			<div class="slimScrollDiv" style="position: relative; text-align: start; overflow: hidden; width: auto; height: 100%;">
				<div data-scrollbar="true" data-height="100%" data-init="true" style="overflow: hidden; width: auto; height: 100%;">
					...
					<li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_DASHBOARD) echo "active"; ?>">
						...
						<li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_CHART) echo "active"; ?>">
							<a href="/admin/chart.php">
								<i class="fa fa-puzzle-piece fa-fw"></i><span>Bảng số liệu</span>
							</a>
						</li>
						...
						<li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_CATEGORY) echo "active"; ?>">
							<a href="/admin/category.php" title="Danh Mục, Phân Loại Sản Phẩm">
						...
						<li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_SETTINGS) echo "active"; ?>">
							<a href="/admin/setting-edit.php" title="System Settings">
								<i class="fa fa-cogs fa-fw"></i> <span>Cài Đặt Hệ Thống</span>
							</a>
						</li>
                    ...
                    <li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_POST_CATEGORY) echo "active"; ?>">
						<a href="/admin/post_category.php" title="Danh Mục, Phân Loại Bài Viết">
						     <i class="fa fa-tags"></i><span>Loại Tin</span>
						</a>
					</li>
					-->
						...
						<!-- <li class="has-sub <?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_SYSTEM) echo "active"; ?>">
							...
							<ul class="sub-menu" style="">
								...
								<li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_BANNER) echo "active"; ?>">
								 ...
								 Đừng đưa Quản Lý File Ảnh vào đây vì giao diện của nó không có layout !
						    trừ khi tạo file admin/images.php sử dụng layout và dùng filemanager.php làm giao 
						    diện riêng.
						    <li class="<?php if ($active_page_admin == ACTIVE_PAGE_ADMIN_FILEMANAGER) echo "active"; ?>">
							 <a href="/admin/filemanager.php" title="Quản Lý Ảnh">
							  <i class="fa fa-commenting-o fa-fw"></i><span>Quản Lý Ảnh</span>
							 </a>
							</li>
