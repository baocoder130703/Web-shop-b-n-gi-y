          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
                ...
                <div class="tab-pane" id="language">
	              ...
	              <div class="form-group">
	                <label class="col-sm-2 control-label" for="input-soluong">số lượng</label>
	                <div class="col-sm-10">
	                  <input type="text" name="soluong" value="<?php echo $product_soluong; ?>" placeholder="amount" id="input-soluong" class="form-control" />
	                </div>
	              </div>
	              <div class="form-group">
                ...
                <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                  <input type="text" name="sale"    value="<?php echo $product_sale; ?>" placeholder=" %" id="input-sale" class="form-control" />
	                </div>
	              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top">Sản Phẩm Mới</label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($product_new) { ?>
                      <input type="checkbox" name="best_new" value="1" checked="checked" id="input-top" class="custom-control-input"/>
                      <?php } else { ?>
                      <input type="checkbox" name="new" value="1" id="input-top" class="custom-control-input"/>
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
