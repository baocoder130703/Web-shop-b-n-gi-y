  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="/admin/product-add.php" data-toggle="tooltip" title="Thêm mới" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        ...
        <button type="submit" form="form-product" formaction="/admin/product-xuat-exel.php" data-toggle="tooltip" title="xuất file exel" class="btn btn-default"><i class="fa fa-file-excel-o"></i></button>
      </div>
      <!-- <h1>Sản Phẩm</h1>-->
      <!-- 
      <ul class="breadcrumb">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">
                    <a href="<?php echo $sort_new; ?>" class="<?php if ($sort == 'p.new') echo strtolower($order); ?>">new</a>
                  </td>
                  <td class="text-left">
                    <a href="<?php echo $sort_sale; ?>" class="<?php if ($sort == 'p.sale') echo strtolower($order); ?>">giảm giá</a>
                  </td>
                  <td class="text-left">
                    <a href="<?php echo $sort_soluong; ?>" class="<?php if ($sort == 'p.soluong') echo strtolower($order); ?>">amount</a>
                  </td>
                  <td class="text-left">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $product['new_text']; ?></td>
                  <td class="text-left"><?php echo $product['sale_text']; ?></td>
                  <td class="text-left"><?php echo $product['soluong']; ?></td>
