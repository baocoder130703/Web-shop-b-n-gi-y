		...
		<DIV class="container">
			...
			<DIV class="nav pull-right" id="top-links">
				<UL class="list-inline">
                    ...
                    <LI>
                        <A title="Wish List (0)" id="wishlist-total" href="product-wishlist.php"><I class="fa fa-heart"></I> <SPAN class="hidden-xs hidden-sm hidden-md">Wish List (0)</SPAN></A>
                    </LI>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<ul class="list-unstyled">
						...
						<li><a href="/product-wishlist.php">Wish List</a></li>
